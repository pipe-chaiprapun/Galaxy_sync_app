...
class _GridTitleText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FittedBox(
      ...
      child: Text(text, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 28)),
    );
  }
}
...
class CatalogState extends State<CatalogPage> {
          ...
          Expanded(
            child: SafeArea(
              ...
              child: GridView.count(
                ...
                childAspectRatio:
                    (orientation == Orientation.portrait) ? 3.0 : 5.0,
