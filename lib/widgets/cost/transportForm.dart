...
class TransportForm extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _transportFormState();
  }
}

enum TransportFormAction { saved, cancel, fail }

class _transportFormState extends State<TransportForm> {
  // PaymentAction action;
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  TransportCost _cost = new TransportCost();
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TextFormField(
                        ...
                        onSaved: (String value) => _cost.description,
  ...
  void _handleSubmitted() {
    ...
    if (!form.validate()) {
      ...
      alert.confirmDialog(context).then((bool ans) {
        ...
        if (ans) {
          DBProvider.db
              .addTransportCost(new TransportCost(
            ...
            if (res > 0) {
              print('saved success');
              Navigator.pop(context, TransportFormAction.saved);
            } else {
    ...
    if (value.isNotEmpty) {
      if (!_isNumeric(value)) {
        ...
        if (double.parse(value) < 1) {
          return 'ค่ายานพาหนะต้องมากกว่า0!';
        }
      }
    } else if (value.isEmpty) {
      return 'กรุณากรอกค่ายานพาหนะ!';
    }
    return null;
  }
